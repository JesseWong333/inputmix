...
if __name__ == '__main__':
    ...
    parser.add_argument('--val_freq', default=2, type=int, help="Epoch frequency for validation.")
    ...
    parser.add_argument('--fusion_mix_p', default=0., type=float, help='the propotion to mix the inputs')
